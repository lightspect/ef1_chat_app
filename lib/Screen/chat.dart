              ...
              child: StreamBuilder(
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  if (!snapshot.hasData) {
                    ...
                    return GroupedListView<MessagesModel, String>(
                      elements: messages,
                      groupBy: (element) => element.sentAt.substring(0, 10),
                      ...
                      indexedItemBuilder: (context, element, index) =>
                          GestureDetector(
                              ...
                              onLongPress: () {
                                showEmojiMenu();
                                _settingModalBottomSheet(element, context);
                              },
                              child: buildItem(index, element)),
                      floatingHeader: true,
